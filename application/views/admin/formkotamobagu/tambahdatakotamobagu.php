...
<div id="page-wrapper">
            <div class="row">
                ...
                <h4>Trayek Kotamobagu-Manado</h4>
                <form method="post" action="<?php echo base_url();?>formkotamobagu/insert">    
                        ...
                        <tr>
                            ...
                            <td> :</td>
                            <select name="j_kendaraan"  id="j_kendaraan" class="form-control">
                                <?php foreach ($kendaraan->result () as $rows) { ?>
